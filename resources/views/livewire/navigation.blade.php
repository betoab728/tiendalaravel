...
<header class="bg-trueGray-700 sticky top-0 z-50" x-data="dropdown()">
    <div  class="container flex items-center h-16 justify-between md:justify-start">
        <a :class="{'bg-opacity-100 text-orange-500' :open}"
            x-on:click="show()"
            class="flex flex-col items-center justify-center order-last md:order-first px-6 md:px-4 bg-white bg-opacity-25 text-white cursor-pointer font-smibold h-full">
        ...
        <div class="container h-full hidden md:block">
            ...
            class="grid grid-cols-4 h-full relative">
                ...
                <div class="col-span-3 bg-gray-100"> 
                    <x-navigation-sucategories :category="$categories->first()"/>
